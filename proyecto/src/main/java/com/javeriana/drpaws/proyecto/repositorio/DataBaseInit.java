...
public class DataBaseInit implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        repoUsuario.save(new Usuario("111111101", "Cristina Peña", "cristina-peña@yahoo.com", "+57 540 196 5692",
        ...
        repoUsuario.save(new Usuario("111111104", "Phil Collins", "phil-collins@hotmail.com", "+57 235 239 2334",
        ...
        repoUsuario.save(new Usuario("111111106", "Prince Rogers", "prince-rogers@hotmail.com", "+57 508 549 5570",
                "password7", "path/to/imageuser7"));

        // Usuario #8 - Henry Cavill
        repoUsuario.save(new Usuario("111111107", "Henry Cavill", "henry-cavill@outlook.com", "+57 009 465 9939",
                "password8", "path/to/imageuser8"));

        // Usuario #9 - James Arthur
        repoUsuario.save(new Usuario("111111108", "James Arthur", "james-arthur@outlook.com", "+57 722 621 6258",
        ...
        repoUsuario.save(new Usuario("111111112", "Madonna Ciccone", "madonna-ciccone@outlook.com", "+57 354 075 6752",
                "password13", "path/to/imageuser13"));

        // Usuario #14 - Natalie Portman
        repoUsuario.save(new Usuario("111111113", "Natalie Portman", "natalie-portman@hotmail.com", "+57 268 588 1644",
                "password14", "path/to/imageuser14"));

        // Usuario #15 - Diana Morales
        repoUsuario.save(new Usuario("111111114", "Diana Morales", "diana-morales@hotmail.com", "+57 561 268 1718",
                "password15", "path/to/imageuser15"));

        // Usuario #16 - Chris Hemsworth
        repoUsuario.save(new Usuario("111111115", "Chris Hemsworth", "chris-hemsworth@gmail.com", "+57 774 728 4449",
                "password16", "path/to/imageuser16"));

        // Usuario #17 - Robbie Williams
        repoUsuario.save(new Usuario("111111116", "Robbie Williams", "robbie-williams@gmail.com", "+57 453 712 6365",
                "password17", "path/to/imageuser17"));

        // Usuario #18 - Robbie Williams
        repoUsuario.save(new Usuario("111111117", "Robbie Williams", "robbie-williams@outlook.com", "+57 102 518 0975",
                "password18", "path/to/imageuser18"));

        // Usuario #19 - Jeremy Renner
        repoUsuario.save(new Usuario("111111118", "Jeremy Renner", "jeremy-renner@hotmail.com", "+57 584 397 7164",
                "password19", "path/to/imageuser19"));

        // Usuario #20 - Jose Soto
        repoUsuario.save(new Usuario("111111119", "Jose Soto", "jose-soto@yahoo.com", "+57 387 614 6770", "password20",
                "path/to/imageuser20"));
        ...
        repoUsuario.save(new Usuario("111111121", "Paulina Rubio", "paulina-rubio@gmail.com", "+57 318 682 5662",
        ...
        repoUsuario.save(new Usuario("111111123", "Chris Hemsworth", "chris-hemsworth@hotmail.com", "+57 965 587 3207",
                "password24", "path/to/imageuser24"));

        // Usuario #25 - Kylie Minogue
        repoUsuario.save(new Usuario("111111124", "Kylie Minogue", "kylie-minogue@outlook.com", "+57 128 651 8233",
                "password25", "path/to/imageuser25"));

        // Usuario #26 - Gloria Estefan
        repoUsuario.save(new Usuario("111111125", "Gloria Estefan", "gloria-estefan@hotmail.com", "+57 257 426 7253",
        ...
        repoUsuario.save(new Usuario("111111127", "Jake Gyllenhaal", "jake-gyllenhaal@outlook.com", "+57 892 259 1975",
                "password28", "path/to/imageuser28"));

        // Usuario #29 - Diana Morales
        repoUsuario.save(new Usuario("111111128", "Diana Morales", "diana-morales@hotmail.com", "+57 250 314 0277",
                "password29", "path/to/imageuser29"));

        // Usuario #30 - Shakira Ripoll
        repoUsuario.save(new Usuario("111111129", "Shakira Ripoll", "shakira-ripoll@gmail.com", "+57 293 503 4739",
        ...
        repoUsuario.save(new Usuario("111111131", "Justin Bieber", "justin-bieber@gmail.com", "+57 756 981 1661",
        ...
        repoUsuario.save(new Usuario("111111133", "Jennifer Lopez", "jennifer-lopez@gmail.com", "+57 137 135 6808",
        ...
        repoUsuario.save(new Usuario("111111135", "Fernanda Lopes", "fernanda-lopes@gmail.com", "+57 825 272 4721",
        ...
        repoUsuario.save(new Usuario("111111139", "Fernanda Lopes", "fernanda-lopes@yahoo.com", "+57 328 098 4121",
                "password40", "path/to/imageuser40"));

        // Usuario #41 - Jose Soto
        repoUsuario.save(new Usuario("111111140", "Jose Soto", "jose-soto@yahoo.com", "+57 811 996 9728", "password41",
                "path/to/imageuser41"));

        // Usuario #42 - Andres Salamanca
        repoUsuario.save(new Usuario("111111141", "Andres Salamanca", "andres-salamanca@yahoo.com", "+57 561 586 2136",
                "password42", "path/to/imageuser42"));

        // Usuario #43 - Paul Rudd
        repoUsuario.save(new Usuario("111111142", "Paul Rudd", "paul-rudd@gmail.com", "+57 680 017 6889", "password43",
                "path/to/imageuser43"));
        ...
        repoUsuario.save(new Usuario("111111146", "Jose Soto", "jose-soto@gmail.com", "+57 491 724 5350", "password47",
                "path/to/imageuser47"));
        ...
        // Usuario #49 - Jessie J
        repoUsuario.save(new Usuario("111111148", "Jessie J", "jessie-j@hotmail.com", "+57 789 745 8069", "password49",
                "path/to/imageuser49"));

        // Usuario #50 - Ariana Grande
        repoUsuario.save(new Usuario("111111149", "Ariana Grande", "ariana-grande@hotmail.com", "+57 911 194 4887",
        ...
        repoUsuario.save(new Usuario("111111152", "Taylor Swift", "taylor-swift@outlook.com", "+57 195 995 5240",
                "password53", "path/to/imageuser53"));

        // Usuario #54 - Sergio Aguilar
        repoUsuario.save(new Usuario("111111153", "Sergio Aguilar", "sergio-aguilar@outlook.com", "+57 173 073 5783",
        ...
        repoUsuario.save(new Usuario("111111155", "Sergio Aguilar", "sergio-aguilar@yahoo.com", "+57 830 810 7924",
        ...
        repoUsuario.save(new Usuario("111111157", "Madonna Ciccone", "madonna-ciccone@hotmail.com", "+57 217 218 0208",
                "password58", "path/to/imageuser58"));

        // Usuario #59 - Jessie J
        repoUsuario.save(new Usuario("111111158", "Jessie J", "jessie-j@gmail.com", "+57 046 402 5878", "password59",
                "path/to/imageuser59"));
        ...
        repoUsuario.save(new Usuario("111111163", "Paula Bermudez", "paula-bermudez@yahoo.com", "+57 300 799 0051",
                "password64", "path/to/imageuser64"));

        // Usuario #65 - Jennifer Lopez
        repoUsuario.save(new Usuario("111111164", "Jennifer Lopez", "jennifer-lopez@hotmail.com", "+57 147 355 3937",
                "password65", "path/to/imageuser65"));

        // Usuario #66 - Jay Z Carter
        repoUsuario.save(new Usuario("111111165", "Jay Z Carter", "jay-z@outlook.com", "+57 127 266 1892", "password66",
                "path/to/imageuser66"));

        // Usuario #67 - Felipe Castro
        repoUsuario.save(new Usuario("111111166", "Felipe Castro", "felipe-castro@yahoo.com", "+57 376 814 4341",
                "password67", "path/to/imageuser67"));

        // Usuario #68 - Chris Hemsworth
        repoUsuario.save(new Usuario("111111167", "Chris Hemsworth", "chris-hemsworth@outlook.com", "+57 277 133 1176",
        ...
        // Usuario #70 - Dua Lipa
        repoUsuario.save(new Usuario("111111169", "Dua Lipa", "dua-lipa@hotmail.com", "+57 411 796 4473", "password70",
                "path/to/imageuser70"));
        ...
        repoUsuario.save(new Usuario("111111172", "Silvia Carreras", "silvia-carreras@gmail.com", "+57 107 634 8954",
        ...
        repoUsuario.save(new Usuario("111111174", "George Michael", "george-michael@outlook.com", "+57 864 300 6445",
                "password75", "path/to/imageuser75"));

        // Usuario #76 - J Balvin
        repoUsuario.save(new Usuario("111111175", "J Balvin", "j-balvin@yahoo.com", "+57 046 678 5480", "password76",
                "path/to/imageuser76"));

        // Usuario #77 - Felipe Castro
        repoUsuario.save(new Usuario("111111176", "Felipe Castro", "felipe-castro@yahoo.com", "+57 293 604 1945",
        ...
        repoUsuario.save(new Usuario("111111180", "Britney Spears", "britney-spears@yahoo.com", "+57 875 420 3319",
                "password81", "path/to/imageuser81"));

        // Usuario #82 - Beyonce Knowles
        repoUsuario.save(new Usuario("111111181", "Beyonce Knowles", "beyonce-knowles@hotmail.com", "+57 738 793 7024",
        ...
        repoUsuario.save(new Usuario("111111183", "Ariana Grande", "ariana-grande@yahoo.com", "+57 719 148 0654",
        ...
        repoUsuario.save(new Usuario("111111188", "Jay Z Carter", "jay-z@outlook.com", "+57 200 264 9064", "password89",
                "path/to/imageuser89"));
        ...
        repoUsuario.save(new Usuario("111111190", "Shakira Ripoll", "shakira-ripoll@gmail.com", "+57 905 117 4210",
        ...
        // Usuario #94 - Rita Ora
        repoUsuario.save(new Usuario("111111193", "Rita Ora", "rita-ora@hotmail.com", "+57 640 421 8868", "password94",
                "path/to/imageuser94"));
        ...
        repoUsuario.save(new Usuario("111111195", "Michael Jackson", "michael-jackson@hotmail.com", "+57 062 442 8940",
                "password96", "path/to/imageuser96"));

        // Usuario #97 - Jessie J
        repoUsuario.save(new Usuario("111111196", "Jessie J", "jessie-j@outlook.com", "+57 121 237 6215", "password97",
                "path/to/imageuser97"));
        ...
        repoUsuario.save(new Usuario("111111198", "Rihanna Fenty", "rihanna-fenty@gmail.com", "+57 584 072 6152",
                "password99", "path/to/imageuser99"));

        // Usuario #100 - Charlie Puth
        repoUsuario.save(new Usuario("111111199", "Charlie Puth", "charlie-puth@hotmail.com", "+57 871 059 1751",
        ...
        // Mascota #2 - Charlie
        repoMascota.save(
                new Mascota("Charlie", "German Shepherd", 10, 46.9f, "Distemper (Moquillo canino)", "path/to/image2"));

        // Mascota #3 - Lucy
        repoMascota.save(new Mascota("Lucy", "English Springer Spaniel", 5, 53.0f, "Sarna (ácaros)", "path/to/image3"));

        // Mascota #4 - Cooper
        repoMascota.save(new Mascota("Cooper", "Yorkshire Terrier", 9, 20.3f, "Enfermedad de Lyme (Borreliosis)",
                "path/to/image4"));
        ...
        // Mascota #6 - Buddy
        repoMascota
                .save(new Mascota("Buddy", "Collie", 8, 12.6f, "Enfermedad de Lyme (Borreliosis)", "path/to/image6"));
        ...
        // Mascota #8 - Rocky
        repoMascota.save(
                new Mascota("Rocky", "Miniature Schnauzer", 1, 45.4f, "Hepatitis infecciosa canina", "path/to/image8"));

        // Mascota #9 - Lola
        repoMascota.save(
                new Mascota("Lola", "Miniature Schnauzer", 5, 43.6f, "Hepatitis infecciosa canina", "path/to/image9"));
        ...
        // Mascota #19 - Maggie
        repoMascota
                .save(new Mascota("Maggie", "Chow Chow", 6, 18.9f, "Hepatitis infecciosa canina", "path/to/image19"));
        ...
        // Mascota #24 - Toby
        repoMascota.save(
                new Mascota("Toby", "Boston Terrier", 9, 55.8f, "Distemper (Moquillo canino)", "path/to/image24"));
        ...
        // Mascota #27 - Lily
        repoMascota.save(
                new Mascota("Lily", "Alaskan Malamute", 10, 50.3f, "Hepatitis infecciosa canina", "path/to/image27"));
        ...
        // Mascota #32 - Murphy
        repoMascota.save(
                new Mascota("Murphy", "Airedale Terrier", 8, 22.4f, "Distemper (Moquillo canino)", "path/to/image32"));
        ...
        // Mascota #38 - Zeke
        repoMascota.save(new Mascota("Zeke", "Rhodesian Ridgeback", 6, 32.6f, "Parásitos intestinales (como lombrices)",
                "path/to/image38"));
        ...
        // Mascota #44 - Jake
        repoMascota.save(new Mascota("Jake", "Cavalier King Charles Spaniel", 13, 18.4f, "Distemper (Moquillo canino)",
                "path/to/image44"));
        ...
        // Mascota #47 - Athena
        repoMascota.save(
                new Mascota("Athena", "Bichon Frise", 0, 31.6f, "Hepatitis infecciosa canina", "path/to/image47"));
        ...
        // Mascota #49 - Abby
        repoMascota.save(
                new Mascota("Abby", "Basset Hound", 6, 45.8f, "Enfermedad de Lyme (Borreliosis)", "path/to/image49"));
        ...
        // Mascota #51 - Harley
        repoMascota.save(
                new Mascota("Harley", "Bloodhound", 13, 30.8f, "Enfermedad de Lyme (Borreliosis)", "path/to/image51"));
        ...
        // Mascota #58 - Sam
        repoMascota.save(
                new Mascota("Sam", "Alaskan Malamute", 7, 10.6f, "Hepatitis infecciosa canina", "path/to/image58"));
        ...
        // Mascota #61 - Sasha
        repoMascota.save(new Mascota("Sasha", "Alaskan Malamute", 7, 19.1f, "Parásitos intestinales (como lombrices)",
                "path/to/image61"));

        // Mascota #62 - Lucky
        repoMascota.save(
                new Mascota("Lucky", "Boston Terrier", 6, 22.3f, "Hepatitis infecciosa canina", "path/to/image62"));
        ...
        // Mascota #64 - Jackson
        repoMascota
                .save(new Mascota("Jackson", "Chow Chow", 6, 8.5f, "Hepatitis infecciosa canina", "path/to/image64"));

        // Mascota #65 - Coco
        repoMascota.save(
                new Mascota("Coco", "Rottweiler", 3, 37.9f, "Enfermedad de Lyme (Borreliosis)", "path/to/image65"));
        ...
        // Mascota #75 - Cleo
        repoMascota
                .save(new Mascota("Cleo", "Newfoundland", 6, 37.8f, "Distemper (Moquillo canino)", "path/to/image75"));
        ...
        // Mascota #78 - Ollie
        repoMascota.save(
                new Mascota("Ollie", "Pug", 10, 34.7f, "Parásitos intestinales (como lombrices)", "path/to/image78"));

        // Mascota #79 - Gracie
        repoMascota.save(new Mascota("Gracie", "Labrador Retriever", 13, 42.4f, "Sarna (ácaros)", "path/to/image79"));

        // Mascota #80 - Marley
        repoMascota.save(new Mascota("Marley", "Cocker Spaniel", 1, 36.2f, "Parásitos intestinales (como lombrices)",
                "path/to/image80"));
        ...
        // Mascota #82 - Sammy
        repoMascota.save(new Mascota("Sammy", "Australian Shepherd", 2, 26.3f, "Enfermedad de Lyme (Borreliosis)",
                "path/to/image82"));
        ...
        // Mascota #84 - Scout
        repoMascota.save(
                new Mascota("Scout", "Border Collie", 10, 30.8f, "Hepatitis infecciosa canina", "path/to/image84"));
        ...
        // Mascota #93 - Honey
        repoMascota.save(new Mascota("Honey", "English Springer Spaniel", 11, 56.6f, "Distemper (Moquillo canino)",
                "path/to/image93"));
        ...
        // Mascota #95 - Nova
        repoMascota.save(
                new Mascota("Nova", "Cocker Spaniel", 4, 33.4f, "Hepatitis infecciosa canina", "path/to/image95"));

        // Mascota #96 - Tank
        repoMascota.save(new Mascota("Tank", "Dalmatian", 5, 25.8f, "Sarna (ácaros)", "path/to/image96"));

        // Mascota #97 - Callie
        repoMascota.save(new Mascota("Callie", "German Shepherd", 15, 6.1f, "Gusano del corazón (Dirofilaria immitis)",
                "path/to/image97"));
        ...
        // Mascota #99 - Princess
        repoMascota.save(
                new Mascota("Princess", "Rottweiler", 2, 33.6f, "Hepatitis infecciosa canina", "path/to/image99"));
        ...
        // Mascota #108 - Frankie
        repoMascota
                .save(new Mascota("Frankie", "Whippet", 3, 28.8f, "Hepatitis infecciosa canina", "path/to/image108"));
        ...
        // Mascota #111 - Angel
        repoMascota.save(
                new Mascota("Angel", "Bloodhound", 5, 37.3f, "Enfermedad de Lyme (Borreliosis)", "path/to/image111"));
        ...
        // Mascota #120 - Oakley
        repoMascota.save(new Mascota("Oakley", "Afghan Hound", 13, 52.3f, "Parásitos intestinales (como lombrices)",
                "path/to/image120"));
        ...
        // Mascota #123 - Tasha
        repoMascota.save(new Mascota("Tasha", "French Bulldog", 6, 3.9f, "Gusano del corazón (Dirofilaria immitis)",
                "path/to/image123"));
        ...
        // Mascota #125 - Misty
        repoMascota
                .save(new Mascota("Misty", "Collie", 0, 17.5f, "Enfermedad de Lyme (Borreliosis)", "path/to/image125"));
        ...
        // Mascota #130 - Simba
        repoMascota.save(
                new Mascota("Simba", "Bloodhound", 0, 59.6f, "Enfermedad de Lyme (Borreliosis)", "path/to/image130"));

        // Mascota #131 - Cookie
        repoMascota.save(
                new Mascota("Cookie", "Afghan Hound", 11, 42.8f, "Hepatitis infecciosa canina", "path/to/image131"));
        ...
        // Mascota #133 - Baby
        repoMascota.save(
                new Mascota("Baby", "Shetland Sheepdog", 4, 1.8f, "Hepatitis infecciosa canina", "path/to/image133"));

        // Mascota #134 - Rocco
        repoMascota.save(new Mascota("Rocco", "Shetland Sheepdog", 14, 32.2f, "Parásitos intestinales (como lombrices)",
                "path/to/image134"));
        ...
        repoMascota.save(new Mascota("Snickers", "Dachshund", 1, 9.5f, "Parásitos intestinales (como lombrices)",
                "path/to/image139"));

        // Mascota #140 - Blue
        repoMascota
                .save(new Mascota("Blue", "Newfoundland", 7, 56.4f, "Hepatitis infecciosa canina", "path/to/image140"));
        ...
        // Mascota #143 - Cherry
        repoMascota.save(
                new Mascota("Cherry", "Maltese", 15, 3.9f, "Enfermedad de Lyme (Borreliosis)", "path/to/image143"));
        ...
        // Mascota #146 - Rudy
        repoMascota
                .save(new Mascota("Rudy", "Collie", 9, 55.7f, "Enfermedad de Lyme (Borreliosis)", "path/to/image146"));

        // Mascota #147 - Hershey
        repoMascota
                .save(new Mascota("Hershey", "Havanese", 12, 50.8f, "Hepatitis infecciosa canina", "path/to/image147"));
        ...
        // Mascota #154 - Champ
        repoMascota.save(
                new Mascota("Champ", "West Highland White Terrier", 13, 5.7f, "Parvovirus canino", "path/to/image154"));

        // Mascota #155 - Caramel
        repoMascota
                .save(new Mascota("Caramel", "Pembroke Welsh Corgi", 11, 21.0f, "Sarna (ácaros)", "path/to/image155"));
        ...
        // Mascota #159 - Muffin
        repoMascota.save(
                new Mascota("Muffin", "German Shepherd", 5, 30.3f, "Distemper (Moquillo canino)", "path/to/image159"));

        // Mascota #160 - Sarge
        repoMascota.save(
                new Mascota("Sarge", "Mastiff", 4, 30.9f, "Enfermedad de Lyme (Borreliosis)", "path/to/image160"));

        // Mascota #161 - Brownie
        repoMascota.save(
                new Mascota("Brownie", "Akita", 6, 58.1f, "Enfermedad de Lyme (Borreliosis)", "path/to/image161"));

        // Mascota #162 - Nico
        repoMascota
                .save(new Mascota("Nico", "English Springer Spaniel", 9, 58.9f, "Leptospirosis", "path/to/image162"));

        // Mascota #163 - Sierra
        repoMascota.save(
                new Mascota("Sierra", "Afghan Hound", 13, 23.1f, "Hepatitis infecciosa canina", "path/to/image163"));
        ...
        // Mascota #171 - Dolly
        repoMascota
                .save(new Mascota("Dolly", "Papillon", 11, 19.3f, "Distemper (Moquillo canino)", "path/to/image171"));
        ...
        // Mascota #174 - Buddy
        repoMascota
                .save(new Mascota("Buddy", "Dalmatian", 0, 13.6f, "Distemper (Moquillo canino)", "path/to/image174"));
        ...
        // Mascota #180 - Jackson
        repoMascota.save(new Mascota("Jackson", "Chow Chow", 12, 43.2f, "Gusano del corazón (Dirofilaria immitis)",
                "path/to/image180"));
